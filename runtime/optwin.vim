...
call append("$", "ralign\tright align the current line number when nu and rnu are set")
call append("$", "\t(local to window)")
call <SID>BinOptionL("ra")
call append("$", "lalign\tleft align line numbers when nu or rnu are set")
call append("$", "\t(local to window)")
call <SID>BinOptionL("la")
if has("linebreak")
